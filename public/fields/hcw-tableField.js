class HCWTableField extends HCWBaseField {
    constructor(label = 'Settings') {
        ...
        this.renderProps = {
            ...
            colors: {
                background: GS.FIELDS.TABLE.BACKGROUND,
                headerBg: GS.FIELDS.TABLE.HEADER_BG,
                headerText: GS.FIELDS.TABLE.HEADER_TEXT,
                rowEven: GS.FIELDS.TABLE.ROW_BG_EVEN,
                rowOdd: GS.FIELDS.TABLE.ROW_BG_ODD,
                cellText: GS.FIELDS.TABLE.TEXT,
                gridLines: GS.FIELDS.TABLE.GRID_LINE,
                deleteBtnBg: GS.PALETTE.KEY_DELETE,
                deleteBtnText: GS.PALETTE.TEXT_PRIMARY,
                addBtnBg: GS.PALETTE.KEY_SPECIAL,
                addBtnText: GS.PALETTE.TEXT_PRIMARY,
